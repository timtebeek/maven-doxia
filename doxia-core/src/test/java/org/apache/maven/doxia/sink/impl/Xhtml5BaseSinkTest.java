...
public class Xhtml5BaseSinkTest {
    ...
    public void testHiddenTableRowStriping() {
        ...
        StringBuilder sbExpected = new StringBuilder("<table class=\"bodyTable\">");
        sbExpected.append(EOL).append("<tr class=\"a\"></tr>").append(EOL);
        sbExpected.append("<tr style=\"bold\" class=\"b\"></tr>").append(EOL);
        sbExpected.append("<tr class=\"hidden xyz abc a\"></tr>").append(EOL);
        sbExpected.append("<tr class=\"abc hidden xyz a\"></tr>").append(EOL);
        sbExpected.append("<tr class=\"a\"></tr>").append(EOL);
        sbExpected.append("<tr class=\"not-hidden xyz b\"></tr>").append(EOL);
        sbExpected.append("<tr class=\"xyz not-hidden a\"></tr>").append(EOL);
        sbExpected.append("<tr style=\"bold\" class=\"xyz abc hidden b\"></tr>").append(EOL);
        sbExpected.append("<tr class=\"xyz hidden-not b\"></tr>").append(EOL);
        sbExpected.append("<tr class=\"a\"></tr></table>");

        String xmlExpected = sbExpected.toString();
        assertEquals(xmlExpected, writer.toString());
    }
